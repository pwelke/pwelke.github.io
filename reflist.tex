...
\href{https://openreview.net/pdf?id=aisVQy6R2k}{Extending Graph Neural Networks with Global Features}\newline
...
\href{https://openreview.net/pdf?id=7vyGCFTajk}{Maximally Expressive GNNs for Outerplanar Graphs}\newline
Learning on Graphs Conference (LoG)\newline
(Extended Abstract)\newline
{\footnotesize
[\href{https://github.com/ocatias/outerplanarGNNs/}{code}]
