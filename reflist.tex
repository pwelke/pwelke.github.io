...
\href{https://pwelke.github.io/}{Search Space Reduction Through Machine Learning for the Electric Autonomous Dial-A-Ride Problem}\newline
International Conference on Machine Learning, Optimization, and Data Science (LOD)\newline
(accepted w/ minor revision)\newline
{\footnotesize
...
\href{https://pwelke.github.io/}{Splitting Stump Forests: Tree Ensemble Compression for Edge Devices (Extended Version)}\newline
Machine Learning\newline
...
\href{https://openreview.net/forum?id=lR5NYB9zrv}{Expressive Pooling for Graph Neural Networks}\newline
